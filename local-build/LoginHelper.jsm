...
const LoginHelper = {
  ...
  secureCredentialProvisionEnabled: null,
  SCP_DUMMYVALUE: "dummYpa$$w0rd",
  ...
  updateSignonPrefs() {
    ...
    this.secureCredentialProvisionEnabled = Services.prefs.getBoolPref(
      "signon.secureCredentialProvision.enabled"
    );
  },
  ...
  processSecureCredentialProvision(logins) {
    ...
    logins.forEach(login => {
      let info = {
        ...
        dummyPassword: LoginHelper.SCP_DUMMYVALUE,
